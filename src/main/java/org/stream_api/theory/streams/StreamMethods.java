...
/**
 * https://webhamster.ru/mytetrashare/index/mtb426/1578962094eafr3wruxs
 *
 ...
 *
 * Конвеерные (intermediate) методы возвращают другой stream, то есть работают как builder их в стриме может быть много.
 * Терминальный (terminal) метод — возвращают другой объект, такой как коллекция, примитивы, объекты, Optional и т.д.,
 * такой метод только один. После его выполнения стрим завершается.
 *
