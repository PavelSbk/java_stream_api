 ...
 *
 * Конвеерные методы возвращают другой stream, то есть работают как builder их в стриме может быть много.
 * Терминальный метод — возвращают другой объект, такой как коллекция, примитивы, объекты, Optional и т.д.,
